"""
Base Tool Class for Portfolio Analysis Tools
"""
...
class BaseTool(ABC):
    """Base class for all portfolio analysis tools"""
    ...
    async def handle_error(self, error: Exception, context: str = "") -> Dict[str, Any]:
        ...
        print(f"Tool {self.tool_id} error{f' in {context}' if context else ''}: {error_message}")
